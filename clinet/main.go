...
//	recvMsgChan := make(chan *s.Message, 20)
//	sendMsgChan := make(chan *s.Message, 20)
...
//
//		var mlen int32
//		mlen = s.ReadInt(buf[:s.MSG_BUFFER_OFFSET])
//		bufd := buf[s.MSG_BUFFER_OFFSET : mlen+s.MSG_BUFFER_OFFSET]
//		_, err = io.ReadFull(con, bufd)
//		if err != nil {
//			fmt.Println("Read data error")
//			return
//		}
//		msg := &s.Message{ReturnData: &bufd}
//		client.connection.Read <- msg
//	}
//
//}
//func handleClienWrite(connection *s.Connection, conn net.Conn) {
//	defer func() {
...
//	return ""
//}
//func (c *TCPClient) GetConnection() s.Connection {
//	return c.connection
//}
